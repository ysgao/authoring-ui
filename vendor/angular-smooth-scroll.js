/* Vendored verbatim: this library (bower package "ngSmoothScroll") was never published to npm
 * and its upstream repo is inactive, so there's no package to install — copied in directly from
 * bower_components/ngSmoothScroll/angular-smooth-scroll.js@1.7.1 rather than left depending on
 * a bower install step nothing else in the build needs anymore. */
/* =============================================================
/*
